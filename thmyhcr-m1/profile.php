...
$result = mysqli_query($link, "SELECT * FROM `orders`, tovars WHERE `id_user`=$user AND tovars.id=orders.id_tovar;");
while($row = mysqli_fetch_array($result))
{
    echo "<tr><td>".$row["id_order"]."</td><td>".$row["name"]."</td><td>".$row["cena"]."</td><td>".$row["quantity"]."</td><td>".$row["datatime"]."</td></tr>";
}
?>
</table>
<p>
